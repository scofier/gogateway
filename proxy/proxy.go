...
func NewMultipleHostReverseProxy(reg Registry, interceptor func(w http.ResponseWriter, r *http.Request) error) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, req *http.Request) {
		...
		//拦截器,没有拦截或者拦截没有错误才放行
		if nil == interceptor || nil == interceptor(w, req) {
			//反向代理
